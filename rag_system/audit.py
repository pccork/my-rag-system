    ...
    *,
    ...
    event: dict[str, Any] = {
        ...
        "pipeline": {
            ...
            "postgres_embedding_dimension": settings.postgres_embedding_dimension,
            "postgres_rrf_k": settings.postgres_rrf_k,
            "postgres_hnsw_m": settings.postgres_hnsw_m,
            "postgres_hnsw_ef_construction": settings.postgres_hnsw_ef_construction,
            "postgres_hnsw_ef_search": settings.postgres_hnsw_ef_search,
            "postgres_hnsw_iterative_scan": settings.postgres_hnsw_iterative_scan,
            "postgres_candidate_multiplier": settings.postgres_candidate_multiplier,
            "postgres_effective_only": settings.postgres_effective_only,
            "postgres_effective_status": settings.postgres_effective_status,
